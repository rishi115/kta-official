...
class AdminFees extends StatelessWidget {
  ...
  final List<ListItem> items = [
    ...
    ListItem(title: 'Varsha gulmohar ( Juhu)'),
    ListItem(title: 'Ajmera Bhakti Park ( Wednesday and Friday )'),
    ListItem(title: 'Andheri Lokhandwala'),
    ListItem(title: 'Kharghar'),
    ListItem(title: 'Byculla'),
  ];
